...
namespace APIVerve
{
    public class EmailDisposableCheckerAPIClient
    {
        ...
        public EmailDisposableCheckerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public EmailDisposableCheckerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, EmailDisposableCheckerQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(EmailDisposableCheckerQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(EmailDisposableCheckerQueryOptions options)
        {
