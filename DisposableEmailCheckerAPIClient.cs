...
namespace APIVerve
{
    public class DisposableEmailCheckerAPIClient
    {
        ...
        public DisposableEmailCheckerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public DisposableEmailCheckerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
